...
#' @example \dontrun{
#' tabla_cruzada <- tablas_cruzadas(diseño = disenio_mult, pregunta = 'P1', dominio = 'Sexo', datos = dataset,
#'  DB_Mult = DB_Mult, tipo_pregunta = 'multiple')
#'  
#' estilo_columnas(tabla = tabla_cruzada, wb = wb, hojas = c(3,4), estilo = verticalStyle, 
#'  renglon = c(1,1), tipo_pregunta = 'categorica')
#' } 
